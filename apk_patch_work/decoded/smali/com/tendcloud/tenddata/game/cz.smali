...
# static fields
.field private static volatile a:Lcom/tendcloud/tenddata/game/cz;
...
.method public static a()Lcom/tendcloud/tenddata/game/cz;
    .locals 2

    .line 245
    sget-object v0, Lcom/tendcloud/tenddata/game/cz;->a:Lcom/tendcloud/tenddata/game/cz;

    if-nez v0, :cond_1

    .line 246
    const-class v0, Lcom/tendcloud/tenddata/game/cz;

    monitor-enter v0

    .line 247
    :try_start_0
    sget-object v1, Lcom/tendcloud/tenddata/game/cz;->a:Lcom/tendcloud/tenddata/game/cz;

    if-nez v1, :cond_0

    .line 248
    new-instance v1, Lcom/tendcloud/tenddata/game/cz;

    invoke-direct {v1}, Lcom/tendcloud/tenddata/game/cz;-><init>()V

    sput-object v1, Lcom/tendcloud/tenddata/game/cz;->a:Lcom/tendcloud/tenddata/game/cz;
...
.method private a(JLcom/tendcloud/tenddata/game/a;)V
    ...
    invoke-virtual {v1, v0}, Lcom/tendcloud/tenddata/game/dx;->setSessionId(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1, p2}, Lcom/tendcloud/tenddata/game/dx;->setSessionStartTime(J)V
    ...
    .line 152
    iput-object p2, p1, Lcom/tendcloud/tenddata/game/db;->b:Ljava/lang/String;

    const-string p2, "begin"

    .line 153
    iput-object p2, p1, Lcom/tendcloud/tenddata/game/db;->c:Ljava/lang/String;
    ...
    .line 158
    iput-object p2, p1, Lcom/tendcloud/tenddata/game/db;->d:Ljava/util/Map;

    .line 159
    iput-object p3, p1, Lcom/tendcloud/tenddata/game/db;->a:Lcom/tendcloud/tenddata/game/a;
    ...
    invoke-virtual {p2, p1}, Lcom/tendcloud/tenddata/game/bv;->post(Ljava/lang/Object;)V

    .line 173
    sget-object p1, Lcom/tendcloud/tenddata/game/ab;->P:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 174
    invoke-direct {p0, p3}, Lcom/tendcloud/tenddata/game/cz;->b(Lcom/tendcloud/tenddata/game/a;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private a(Lcom/tendcloud/tenddata/game/a;)V
    ...
    .line 100
    :cond_1
    new-instance v5, Lcom/tendcloud/tenddata/game/db;

    invoke-direct {v5}, Lcom/tendcloud/tenddata/game/db;-><init>()V

    const-string v6, "session"

    .line 101
    iput-object v6, v5, Lcom/tendcloud/tenddata/game/db;->b:Ljava/lang/String;

    const-string v6, "end"

    .line 102
    iput-object v6, v5, Lcom/tendcloud/tenddata/game/db;->c:Ljava/lang/String;
    ...
    .line 107
    iput-object v6, v5, Lcom/tendcloud/tenddata/game/db;->d:Ljava/util/Map;

    .line 108
    iput-object p1, v5, Lcom/tendcloud/tenddata/game/db;->a:Lcom/tendcloud/tenddata/game/a;
    ...
    invoke-virtual {v0, v5}, Lcom/tendcloud/tenddata/game/bv;->post(Ljava/lang/Object;)V

    .line 119
    invoke-direct {p0, p1}, Lcom/tendcloud/tenddata/game/cz;->b(Lcom/tendcloud/tenddata/game/a;)V
...
.method private b(Lcom/tendcloud/tenddata/game/a;)V
    ...
    .line 211
    iput-object p1, v0, Lcom/tendcloud/tenddata/game/da;->a:Lcom/tendcloud/tenddata/game/a;

    .line 212
    sget-object p1, Lcom/tendcloud/tenddata/game/da$a;->IMMEDIATELY:Lcom/tendcloud/tenddata/game/da$a;

    iput-object p1, v0, Lcom/tendcloud/tenddata/game/da;->b:Lcom/tendcloud/tenddata/game/da$a;
...
.method private final b(Ljava/util/HashMap;)V
    ...
    .line 69
    invoke-direct {p0, v0}, Lcom/tendcloud/tenddata/game/cz;->a(Lcom/tendcloud/tenddata/game/a;)V

    .line 70
    invoke-direct {p0, v1, v2, v0}, Lcom/tendcloud/tenddata/game/cz;->a(JLcom/tendcloud/tenddata/game/a;)V
    ...
    invoke-virtual {v0, p1}, Lcom/tendcloud/tenddata/game/dx;->setSessionId(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v3, v4}, Lcom/tendcloud/tenddata/game/dx;->setSessionStartTime(J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final c(Ljava/util/HashMap;)V
    ...
    .line 188
    invoke-direct {p0, v1}, Lcom/tendcloud/tenddata/game/cz;->a(Lcom/tendcloud/tenddata/game/a;)V
    ...
    .line 196
    :cond_1
    invoke-direct {p0, v1}, Lcom/tendcloud/tenddata/game/cz;->b(Lcom/tendcloud/tenddata/game/a;)V
    ...
    .line 198
    sput-object p1, Lcom/tendcloud/tenddata/game/ab;->D:Ljava/lang/String;
...
.method private d(Ljava/util/HashMap;)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lcom/tendcloud/tenddata/game/cz;->a(JLcom/tendcloud/tenddata/game/a;)V
...
.method private e(Ljava/util/HashMap;)V
    ...
    .line 233
    invoke-direct {p0, p1}, Lcom/tendcloud/tenddata/game/cz;->a(Lcom/tendcloud/tenddata/game/a;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final onTDEBEventSession(Lcom/tendcloud/tenddata/game/zz$a;)V
    ...
    invoke-direct {p0, p1}, Lcom/tendcloud/tenddata/game/cz;->b(Ljava/util/HashMap;)V
    ...
    invoke-direct {p0, p1}, Lcom/tendcloud/tenddata/game/cz;->c(Ljava/util/HashMap;)V
    ...
    invoke-direct {p0, p1}, Lcom/tendcloud/tenddata/game/cz;->d(Ljava/util/HashMap;)V
    ...
    invoke-direct {p0, p1}, Lcom/tendcloud/tenddata/game/cz;->a(Ljava/util/HashMap;)V
    ...
    invoke-direct {p0, p1}, Lcom/tendcloud/tenddata/game/cz;->e(Ljava/util/HashMap;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
