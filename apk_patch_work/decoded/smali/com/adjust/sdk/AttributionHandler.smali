...
.method private checkAttributionI(Lcom/adjust/sdk/IActivityHandler;Lcom/adjust/sdk/ResponseData;)V
    ...
    .line 174
    invoke-direct {p0, v0, v1, v4}, Lcom/adjust/sdk/AttributionHandler;->getAttributionI(JZ)V

    return-void

    .line 178
    :cond_1
    invoke-interface {p1, v4}, Lcom/adjust/sdk/IActivityHandler;->setAskingAttribution(Z)V
...
.method private sendAttributionRequestI()V
    ...
    .line 240
    :cond_2
    iget-object v3, v0, Lcom/adjust/sdk/ResponseData;->trackingState:Lcom/adjust/sdk/TrackingState;
