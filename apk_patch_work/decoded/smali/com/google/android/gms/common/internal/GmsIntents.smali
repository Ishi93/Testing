...
.method public static createPlayStoreLightPurchaseFlowIntent(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    const-string p2, "https://play.google.com/store/apps/details?id=%1$s&rdid=%1$s&rdot=%2$d"
...
.method public static createShareOnPlusIntent(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-virtual {p1, p2}, Landroidx/core/app/ShareCompat$IntentBuilder;->setType(Ljava/lang/String;)Landroidx/core/app/ShareCompat$IntentBuilder;
    ...
    :cond_0
    invoke-static {p2}, Lcom/google/android/gms/common/internal/GmsIntents;->createPlayStoreIntent(Ljava/lang/String;)Landroid/content/Intent;
...
.method public static createShowProfileIntent(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    const-string p1, "https://plus.google.com/%s/about"
...
.method public static sendUdcSettingsChangedBroadcast(Landroid/content/Context;Ljava/lang/String;[I)V
    ...
    const-string p0, "Google now certificate not valid. UDC settings broadcast will not be sent."
    ...
    :cond_1
    invoke-static {v1, p0, p1, p2}, Lcom/google/android/gms/common/internal/GmsIntents;->zza(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;[I)V
...
.method private static zza(Landroid/content/Context;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/internal/GmsIntents;->createPlayStoreIntent(Ljava/lang/String;)Landroid/content/Intent;
